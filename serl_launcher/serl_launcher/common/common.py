...
class ModuleDict(nn.Module):
    ...
    def get_features(self, *args, name=None, **kwargs):
        """Forward feature extraction to a named child module."""
        if name is None:
            raise ValueError("Feature extraction requires a module name")
        return self.modules[name].get_features(*args, **kwargs)
